...
# Compiler flags, etc., for NAG.  Only debugging flags are used.
MPIF90_nagfor=nagfor
FFLAGS_nagfor_debug=-C=all -colour -f2003 -info -mtrace=off -nan -O0 -strict95\
 -u -v
FFLAGS_nagfor_none=
FFLAGS_nagfor_opt=$(FFLAGS_nagfor_debug)
FFLAGS_OPENMP_yes_nagfor=-openmp
FFLAGS_OPENMP_no_nagfor=-C=undefined -gline # Avoid compiler bug.
